...
[Website](https://tellus-omega.vercel.app)
...
2. Paste it into your website's HTML where you want the testimonials to appear:
   ...
   ```html
   <iframe src="https://tellus-omega.vercel.app/embed/830532" height="500px" width="1000px"></iframe>
   ```
3. Preview your embedded testimonials at:
   ```
   https://tellus-omega.vercel.app/embed/YOUR_CODE
   ```
